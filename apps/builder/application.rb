...
module Builder
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['BUILDER_SESSIONS_SECRET']
      ...
      # Configure the code that will yield each time Builder::Action is included
      ...
      # Configure the code that will yield each time Builder::View is included
      # This is useful for sharing common functionality
      #
