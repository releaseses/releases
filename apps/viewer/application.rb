...
module Viewer
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['VIEWER_SESSIONS_SECRET']
      ...
      # Configure the code that will yield each time Viewer::Action is included
      ...
      # Configure the code that will yield each time Viewer::View is included
      # This is useful for sharing common functionality
      #
