...
describe 'List releases', type: :feature do
  before do
    ...
    ReleaseRepository.new.create({ version: '1.0.0', title: 'First release',  released_at: now - 3600 })
    ReleaseRepository.new.create({ version: '2.0.0', title: 'Second release', released_at: now })
